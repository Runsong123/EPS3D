...
def _make_pretrained_clip_vitl16_384(
    ...
    clip_download_root = os.path.dirname(os.environ["CLIP_CHECKPOINT_PATH"]) if os.environ.get("CLIP_CHECKPOINT_PATH") else None
    clip_pretrained, _ = clip.load("ViT-B/32", device='cuda', jit=False, download_root=clip_download_root)
